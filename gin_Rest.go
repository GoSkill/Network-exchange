/*	30.5 Практическая работа: написать HTTP-сервис (с JSON-данными)
	...
	2. который делает друзей из двух пользователей
	3. который удаляет пользователя
	4. который возвращает всех друзей пользователя
	5. который обновляет возраст пользователя
